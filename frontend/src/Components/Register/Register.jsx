...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - 70% */}
      <div className="hidden lg:flex lg:w-[70%] bg-gradient-to-br from-green-600 to-green-800 p-12 flex-col justify-center relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 max-w-2xl">
          <div className="flex items-center space-x-3 mb-8">
            ...
            <span className="text-3xl font-bold text-white">SecureGateway</span>
          </div>
      ...
      <div className="w-full lg:w-[30%] flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="mb-8">
            <button 
              onClick={() => navigate('/')}
              className="flex items-center text-gray-600 hover:text-green-600 transition-colors mb-6"
            >
