        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl">
                Get Started Free
              </button>
              <button className="bg-white hover:bg-gray-50 text-gray-900 px-6 py-3 rounded-lg font-semibold transition-all duration-200 border-2 border-gray-200 hover:border-green-600">
                Watch Demo
              </button>
            </div>
            ...
            <div className="relative z-10 bg-white rounded-xl shadow-xl p-6 border border-gray-100">
              <div className="space-y-3">
                <div className="flex items-center justify-between pb-3 border-b border-gray-200">
                  <span className="text-gray-700 font-semibold text-sm">Document Ready</span>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-900 text-sm">Contract Agreement</p>
                  ...
                  <div className="border-2 border-dashed border-green-300 rounded-lg p-4 text-center">
                    ...
                    <p className="text-gray-700 font-medium text-sm">Click to Sign</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="absolute -bottom-4 -right-4 w-full h-full bg-gradient-to-br from-green-400 to-green-600 rounded-xl -z-0"></div>
          </div>
        </div>
      </div>
    </section>
