...
const RentalListing = ({
  ...
  const [RentalListingData, setRentalListingData] = useState(Rental_Lisiting);
  ...
  const [rowData, setRowData] = useState({
    propert_owners_names: RentalListingData.owners || "-",
    email: RentalListingData.email || "-",
    owners_postal_address: RentalListingData.owners_address || "-",
    listed_property_address: RentalListingData.property_address || "-",
    rental_price: RentalListingData.rental_price || "-",
  });
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const addTableInRowContainer = (rows, options = {}) => {
        ...
        const rowHeight = 10;
        const tableHeight = rows.length * rowHeight + margin * 1.3;
      ...
      currentY += 8;
      addContent(`GENERAL LISTING FORM (Rental Listing)`, {
        fontSize: 13,
        fontStyle: "bold",
        align: "center",
      });
      ...
      addTableInRowContainer(
        [
          { col1: "OWNERS", col2: rowData.propert_owners_names || "-" },
          {
            col1: "EMAIL",
            col2: rowData.email || "-",
          },
          ...
          {
            col1: "PROPERTY ADDRESS",
            col2: rowData.listed_property_address || "-",
          },
          {
            col1: "RENTAL ASKING PRICE(per Week)",
            col2: rowData.rental_price || "-",
          },
        ],
        {
          containerWidth: 190,
      ...
      const text = `1. You have agreed to all the ‘Terms & conditions’ on www.salebyhomeowner.com.au when signing up via their website (www.salebyhomeowner.com.au). Those Terms & conditions form part of this authority & should be read together.
      ...
      3. You hereby authorise & instruct salebyhomeowner.com.au to publish & list your property for rent & related information on all websites as per the ‘terms & conditions”.
      4. You agree to inform salebyhomeowner.com.au immediately once the Property is Tenanted. To change the Status of your Ad, login to your account & change your status from ‘Available’ to ‘Leased’.
      5. The person/s signing this document declare they are the registered owners of the property, or have in writing the necessary right & approvals to market & rent the property.`;
      ...
      if (download) {
        const filename = `${rec_name}-Rental_listing-${formattedDate}_${formattedTime}.pdf`;
        setDownload(false);
        setLoading(false);
      } else {
        const filename = `${rec_name}-Rental_listing-${formattedDate}_${formattedTime}.pdf`;
  ...
  const dataMapping = [
    ...
    { col1: "OWNERS ADDRESS", col2: rowData.owners_postal_address },
    { col1: "PROPERTY ADDRESS", col2: rowData.listed_property_address },
    { col1: "RENTAL ASKING PRICE (per week)", col2: rowData.rental_price },
  ];
        ...
        <Grid>
          <>
            <Grid mt={2}>
              ...
              >
                GENERAL LISTING FORM <i>(Rental Listing)</i>
              </Typography>
            </Grid>
            ...
            <Grid style={{ border: "2px solid black" }} p={2} mt={1}>
              ...
              >
                *Please fill out below, sign,&return to Email above*
              </Typography>
            ...
            <Grid style={{ border: "2px solid black" }} p={2} mt={1}>
              ...
              >
                ...
                when signing up via their website(www.SaleByHomeOwner.com.au) -
                Those Terms & conditions form part of this authority & should be
                read together.
              </Typography>
              <Typography
                variant="body1"
              ...
              >
                ...
                SaleByHomeOwner.com.au to publish & list your property for
                rent(& related information) on all websites as per the ‘terms &
                conditions”
              </Typography>
              <Typography
                variant="body1"
              ...
              >
                ...
                immediately once the Property is Tenanted. To change the Status
                of your Ad, login to your account & change your status from
                ‘Available’ to ‘Leased’
              </Typography>
              <Typography
                variant="body1"
              ...
              >
                ...
                writing the necessary right & approvals to market & rent the
                Property.
              </Typography>
            </Grid>
